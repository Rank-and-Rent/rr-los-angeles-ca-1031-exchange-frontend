      ...
      <form className="space-y-6" data-type="contact-form" action="/api/contact" method="post">
        ...
        <div>
          ...
          <textarea id="contact-notes"
            className="w-full resize-none border border-white/20 bg-transparent px-4 py-3 text-sm text-white placeholder-white/40 transition-colors focus:border-cream focus:outline-none" name="notes" rows={5} placeholder="Share any exchange questions or context"></textarea>
        </div>
