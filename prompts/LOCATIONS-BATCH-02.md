...
1) venice — Venice, CA  Layout: loc_industry_spotlight

2) marina-del-rey — Marina Del Rey, CA  Layout: loc_commute_corridor

3) malibu — Malibu, CA  Layout: loc_neighborhoods_grid

4) burbank — Burbank, CA  Layout: loc_data_column

5) glendale — Glendale, CA  Layout: loc_university_hub

6) pasadena — Pasadena, CA  Layout: loc_map_first

7) san-fernando-valley — San Fernando Valley, CA  Layout: loc_industry_spotlight
...
export const locationsBatch02 = { "[slug]": { layoutKey:"[layout-key]", mainDescription:"<p>...</p>", popularPaths:[{rank:1,type:"service or propertyType",slug:"...",name:"...",whyPopular:"..."}], faqs:[{question:"...",answer:"..."}], exampleCapability:{...} } }